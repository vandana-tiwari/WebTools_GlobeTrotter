...
<body>
	<div class="header_bg">
				...
				<div class="h_right">
					...
					<ul class="menu">
						...
						<c:if test="${!empty sessionScope.loggedInUser}">
							...
							<li class="active"><a href="acountInfo.htm">MY ACCOUNT</a></li> 
							<li style="list-style: none">|</li>
		...
		<h2>Account Info: ${sessionScope.loggedInUserName}</h2>
		<div>
		<ul>
		<li><a href="myAccount.htm">My Account Details</a></li>
		<li><a href="myBookings.htm">My Bookings</a></li>
		</ul>
		</div>
