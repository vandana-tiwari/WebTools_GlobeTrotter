...
<form action="updatePswd.htm" method="post">
	<div>
		<span><label>USERNAME</label></span> <span><input
			name="userName" value="${sessionScope.loggedInUser}" readonly="true"
			size="30" type="text" class="textbox" /></span>
	</div>

	<div>
		<span><label>CURRENT PASSWORD</label></span> <span><input
			type="password" name="currPswd" size="30" class="textbox" /></span>
	</div>

	<div>
		<span><label>NEW PASSWORD</label></span> <span><input
			type="password" name="newPswd" size="30" class="textbox" /></span>
	</div>
