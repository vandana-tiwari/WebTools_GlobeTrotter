...
<h1>Thank you for booking with us!!</h1><br>
<h3>Hope you have a wonderful stay.</h3>
<form action="downloadBooking.htm" method="post">		
	<a href="downloadBooking.htm">Download Booking confirmation</a>
</form>
</body>
</html>